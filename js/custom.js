...
function letArrowsWork()
{
	...
	{
		errors++;
		document.getElementById("wrongYear").style.display="block";
	}
...
function setPicker(id)
{
	...
	if(activePicker=="picker1"){chosenType="Номер: Стандарт \n";}
	else{chosenType="Номер: Эконом \n"}
